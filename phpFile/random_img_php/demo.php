...
/////////////////////////////////////////////////////////////////////
//開啟目錄資料夾 把所有檔案存入陣列，再getRandomFromArray隨機一筆檔案 在存在陣列裡 在顯示出來。
    ...
    if ( $img_dir = @opendir($path) ) {
        while ( false !== ($img_file = readdir($img_dir)) ) {
            ...
            if ( preg_match("/(\.gif|\.jpg|\.png)$/", $img_file) ) {
                $images[] = $img_file;//call rand of picture set in array 
				echo 'All pictures   '.$images[] = $img_file."<br />";
...
function getRandomFromArray($ar) {
    ...
    $num = array_rand($ar);
	echo "now rand is  "."<b>".$ar[$num]."</b>"."<br />";
